...
def diamond_recommendation_user_product_scoring(params):
    """
    ...
    ultimate_df.to_csv(
        output_path
        + "diamond_recommendation_user_product_feature"
        + scoring_date
        + ".csv"
    )
...
if __name__ == "__main__":
    params = json.load(open("diamond.json"))
    diamond_recommendation_user_product_scoring(params)