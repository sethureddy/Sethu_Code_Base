...
mkdir /ds_model_run
cd /ds_model_run
sudo gsutil -m cp -r gs://$CS_BUCKET/dags/scripts/universal_profile/recommendation_model_set3/* .
...
sudo python3 diamond_recommendation_user_product_scoring.py
#
##setting recommendation
sudo python3 settings_recommendation_user_product_scoring.py
#
##jewellery recommendation
sudo python3 jewellery_recommendation_user_product_scoring.py
