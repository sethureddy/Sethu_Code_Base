...
read_dedup_map="""SELECT distinct primary_bnid,duplicate_bnid FROM `bnile-cdw-prod.up_stg_dedup.bnid_dedup_map_probablistic`"""
...
# Write back to BQ
df.to_gbq(destination_table='up_stg_dedup.bnid_dedup_merge',project_id='bnile-cdw-prod',if_exists='replace',chunksize=1000000)