...
from scripts.universal_profile.id_resolution.user_input import address
from scripts.universal_profile.id_resolution.user_input import email_base1
from scripts.universal_profile.id_resolution.user_input import email_base2
from scripts.universal_profile.id_resolution.user_input import phone_base1
from scripts.universal_profile.id_resolution.user_input import phone_base2
from scripts.universal_profile.id_resolution.user_input import payment
...
def id_resolution_task_preprocess(gcs_bucket, directory_path, model_name, execution_date):
    ...
    address_sql_output= "up_stg_customer.address_id_resolution_" + execution_date
    email_base1_sql_output= "up_stg_customer.email_base1_id_resolution_" + execution_date
    email_base2_sql_output= "up_stg_customer.email_base2_id_resolution_" + execution_date
    payment_sql_output= "up_stg_customer.payment_id_resolution_" + execution_date
    phone_base1_sql_output= "up_stg_customer.phone_base1_id_resolution_" + execution_date
    phone_base2_sql_output= "up_stg_customer.phone_base2_id_resolution_" + execution_date
