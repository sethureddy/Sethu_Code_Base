...
mkdir /ds_model_run
cd /ds_model_run
sudo gsutil -m cp -r gs://$CS_BUCKET/dags/scripts/universal_profile/recommendation_model_set2/* .
sudo gsutil -m cp -r gs://$CS_BUCKET/$DIRECTORY_PATH/conf/$EXECUTION_DATE/* .
sudo mv diamond/diamond_recommendation_product_scoring.py setting/settings_recommendation_product_feature_scoring.py jewellery/jewellery_recommendation_feature_scoring.py .
...
sudo python3 diamond_recommendation_product_scoring.py

#setting recommendation
sudo python3 settings_recommendation_product_feature_scoring.py

#jewellery recommendation
sudo python3 jewellery_recommendation_feature_scoring.py
