...
def settings_recommendation_product_scoring(paramas):
    """
    ...
    # appending recommendations file
...
if __name__ == "__main__":
    params = json.load(open("rc2_setting.json"))
    settings_recommendation_product_scoring(params)
