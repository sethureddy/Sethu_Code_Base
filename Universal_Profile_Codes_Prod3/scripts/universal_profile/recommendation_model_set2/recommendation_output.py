...
def recommendation_model_output(params):
    diamond_input_file = params["diamond_file"]
    setting_input_file = params["setting_file"]
    jewellery_input_file = params["jewellery_file"]
    ...
    # Saving ouput
    recommendations_output.to_csv(output_path)


if __name__ == "__main__":
    params = json.load(open("rc2_recommendation.json"))
