...
mkdir /ds_model_run
cd /ds_model_run
sudo gsutil -m cp -r gs://$CS_BUCKET/dags/scripts/universal_profile/item_item_similarity_codes/* .
sudo gsutil -m cp -r gs://$CS_BUCKET/$DIRECTORY_PATH/conf/* .
sudo mv settings/settings_recommendation_optimized_Interactions.py jewellery/jewelery_item_item_code.py .
...
##jewelery
sudo python3 jewelery_item_item_code.py
#
##settings recommendation
sudo python3 settings_recommendation_optimized_Interactions.py
