...
def item_item_similarity_setting(params):
    """
    ...
    df_offerid_recommended["OID_type"] = "settings"

    # Saving Item-item Similarities
    df_offerid_recommended.to_csv(output_path + "settings_output.csv", index=False)

if __name__ == "__main__":
    params = json.load(open("settings.json"))
    item_item_similarity_setting(params)