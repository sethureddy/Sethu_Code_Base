...
dag_id="cross_category_recommendation"
delete_inter_table_task_id="cross_reco_check_delete_intermediate_tables"
first_task_id= "cross_reco_setup_conf_files"
append_task_id="cross_reco_append_final_csv_output_to_inter_table"
    ...
    while True:
        ...
        if(execution_date==todays_date):
            ...
            if(status_of_append_task =="success" and execution_date==todays_date):
                ...
                tasks_from_append = ["cross_reco_append_final_csv_output_to_inter_table","cross_reco_insert_from_intermediate_to_final","cross_reco_check_delete_intermediate_tables","send_mail_on_success"]
