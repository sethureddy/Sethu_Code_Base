...
dag_id="recommendation_model_deploy"
delete_inter_table_task_id="delete_intermediate_tables"
first_task_id= "start_recommendation_set_1"
append_task_id="append_final_csv_output_to_table"
    ...
    while True:
        ...
        if(execution_date==todays_date):
            ...
            if(status_of_append_task =="success" and execution_date==todays_date):
                ...
                tasks_from_append = ["append_final_csv_output_to_table","insert_from_intermediate_to_final","delete_intermediate_tables","send_mail_on_success","end_recommendation_set_1"]
