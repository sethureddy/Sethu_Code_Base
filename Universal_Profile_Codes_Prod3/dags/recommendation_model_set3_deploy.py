...
from scripts.universal_profile.recommendation_model_set3.model_task_preprocess import (
...
GCS_DIR_PATH = "data/recommendation_model_set3"
VM_CREATION_CODE_PATH = "/home/airflow/gcs/dags/scripts/universal_profile/recommendation_model_set3/vm_api"
VM_INSTANCE_ZONE = "us-central1-a"
VM_INSTANCE_NAME = "ds-model-set3-deploy-automation-" + EXECUTION_DATE
...
FINAL_INTERMEDIATE_TABLE = (
    "o_customer.bn_product_recommendation_intermediate_set3_" + EXECUTION_DATE
)
FINAL_RECOMMENDATION_CSV = (
    GCS_DIR_PATH + "/output/recommendation_" + EXECUTION_DATE + "/recommendation.csv"
)
...
# Dag tasks
with models.DAG(
    "recommendation_model_set3",
    schedule_interval=None,
    default_args=DEFAULT_DAG_ARGS,
) as dag:

    task_start_3 = dummy_operator.DummyOperator(task_id="start_recommendation_set_3", dag=dag)

    # Load local conf files to GCS
    task_setup_conf_files_3 = bash_operator.BashOperator(
        task_id="setup_conf_files_3",
    ...
    task_rm_local_conf_files_3 = bash_operator.BashOperator(
        task_id="rm_local_conf_files_3",
    ...
    task_setting_bq_exec_3 = bigquery_operator.BigQueryOperator(
        task_id="setting_bq_exec_3",
    ...
    task_jewellery_bq_exec_3 = bigquery_operator.BigQueryOperator(
        task_id="jewellery_bq_exec_3",
    ...
    task_setting_export_query_data_gcs_3 = bigquery_to_gcs.BigQueryToCloudStorageOperator(
        task_id="setting_export_query_data_gcs_3",
    ...
    task_jewellery_export_query_data_gcs_3 = bigquery_to_gcs.BigQueryToCloudStorageOperator(
        task_id="jewellery_export_query_data_gcs_3",
    ...
    task_vm_creation_run_scoring_3 = bash_operator.BashOperator(
        task_id="vm_creation_run_scoring_3",
    ...
    # Delete VM
    task_vm_deletion_3 = bash_operator.BashOperator(
        task_id="vm_deletion_3",
    ...
    task_append_final_csv_output_to_table_3 = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id="append_final_csv_output_to_table_3",
    ...
    task_insert_from_intermediate_to_final_3 = bigquery_operator.BigQueryOperator(
        task_id="insert_from_intermediate_to_final_3",
        sql="""delete from `{PROJECT_ID}.{FINAL_TABLE_OUTPUT}` where MODEL_SEQ=3 and run_date=(
...
#
    ...
    task_delete_intermediate_sql_tables_3 = bigquery_operator.BigQueryOperator(
        task_id="delete_intermediate_tables_3",
    ...
    subject='UP ETL Alert:Success(bn_recommendation_set_3)',
    html_content=''' 
    Hi,<br>
    
    <p>This email is to inform you that, recommendation set 3 pipeline has been successfully completed.<br>
           <br>
    -<br>
    UP Team.<p>''',
    dag=dag)

    task_end_3 = dummy_operator.DummyOperator(task_id="end_recommendation_set_3", dag=dag)

    # def trigger(context, dag_run_obj):
        # dag_run_obj.payload = {'message': context['params']['message']}
        # return dag_run_obj
        
    bn_reco_json_trigger = TriggerDagRunOperator(
        dag=dag,
        task_id='delay_python_task',
        trigger_dag_id="bn_recommendations_json_prod_dag",
        # python_callable=trigger,
        params={'message': 'Hello World'}
    )

    task_start_3 >> task_setup_conf_files_3 >> task_rm_local_conf_files_3

    task_rm_local_conf_files_3 >> task_diamond_bq_exec_3 >> task_diamond_export_query_data_gcs_3 >> task_vm_creation_run_scoring_3
    task_rm_local_conf_files_3 >> task_setting_bq_exec_3 >> task_setting_export_query_data_gcs_3 >> task_vm_creation_run_scoring_3
    task_rm_local_conf_files_3 >> task_jewellery_bq_exec_3 >> task_jewellery_export_query_data_gcs_3 >> task_vm_creation_run_scoring_3

    task_vm_creation_run_scoring_3 >> task_vm_deletion_3 >> task_append_final_csv_output_to_table_3 >> task_insert_from_intermediate_to_final_3 >> task_delete_intermediate_sql_tables_3 >> task_end_3
    task_end_3 >> bn_reco_json_trigger
    task_delete_intermediate_sql_tables_3 >> task_email_on_success
