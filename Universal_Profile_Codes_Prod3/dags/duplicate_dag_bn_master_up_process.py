...
from scripts.universal_profile.duplicate_master_up_process.explicit_process import explicit_process
from scripts.universal_profile.duplicate_master_up_process.bn_customer_explicit_process import bn_customer_explicit_process
from scripts.universal_profile.duplicate_master_up_process.pj_rfm import pj_rfm
...
with DAG('duplicate_master_up_process', schedule_interval=None, default_args=default_args) as dag:
...
# task_email_on_success = EmailOperator(
    ...
    # <br>
    # 1.lc model, sc model,recomendation 1,2 and 3 models.
