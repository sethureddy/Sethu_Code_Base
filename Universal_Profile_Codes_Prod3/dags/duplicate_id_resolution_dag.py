...
from scripts.universal_profile.duplicate_id_resolution.bnq_conf import PARAMS_QUERY
from scripts.universal_profile.duplicate_id_resolution.model_task_preprocess import id_resolution_task_preprocess
...
GCS_DIR_PATH = "data/duplicate_id_resolution"
VM_CREATION_CODE_PATH = "/home/airflow/gcs/dags/scripts/universal_profile/duplicate_id_resolution/vm_api"
VM_INSTANCE_ZONE = "us-central1-a"
VM_INSTANCE_NAME = "dup-id-resolution-" + EXECUTION_DATE
...
FINAL_INTERMEDIATE_TABLE = "bnile-cdw-prod.up_stg_customer.dup_id_resolution_" +EXECUTION_DATE
FINAL_TABLE_OUTPUT = "bnile-cdw-prod.dag_migration_test.duplicate_id_resolution"
